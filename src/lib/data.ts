...
export const submissions: PodcastSubmission[] = [
  ...
  },
  {
    ...
    description: "An introduction to mindfulness and meditation techniques to reduce stress and improve focus.",
    ...
    audioUrl: "https://storage.googleapis.com/studioprod-media/sotw-2245-discover.mp3",
    statusHistory: [
      { status: "pending", changedAt: "2024-02-10T15:00:00Z" },
    ],
  },
  {
    id: "11223",
    title: "Cybersecurity Threats Today",
    description: "Exploring the latest cybersecurity threats and how to protect yourself and your business online.",
    ...
    statusHistory: [
      ...
      { status: "approved", changedAt: "2024-02-09T13:00:00Z" },
    ],
  },
  {
    id: "44556",
    title: "The Keto Diet Explained",
    description: "A deep dive into the ketogenic diet, its benefits, risks, and what you can eat.",
  ...
  },
  {
    ...
    description: "Learn the fundamental principles of graphic design, including color theory, typography, and layout.",
    ...
    audioUrl: "https://storage.googleapis.com/studioprod-media/sotw-2245-discover.mp3",
    statusHistory: [
      { status: "pending", changedAt: "2024-02-07T10:10:00Z" },
    ],
  },
  {
    id: "99001",
    title: "Financial Independence",
    description: "Strategies for achieving financial independence and retiring early (FIRE movement).",
